...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      let width = this.config.graph_width;
      console.log('this.config: ', this.config);
      console.log('this.config.graph_width: ', this.config.graph_width);
      console.log('this.config.graph_height: ', this.config.graph_height);
      console.log('width: ', width);
      let height = this.config.graph_height;
      ...
      if (this.isClosePath) {
        if (this.isMousedown) {
          if (this.dragPointIndex !== -1) {
            ...
            // 拖拽多边形
            console.log('this.startPos.x: ', this.startPos.x);
            let diffX = x - this.startPos.x;
            console.log('diffX: ', diffX);
            let diffY = y - this.startPos.y;
            console.log('this.cachePointsArr: ', this.cachePointsArr);
            ...
            console.log('this.pointsArr: ', this.pointsArr);
